...
Sin embargo, la información se publica **año a año en archivos Excel independientes**, con formatos que han cambiado significativamente entre 2005 y 2023. Existen portales autonómicos y herramientas sectoriales (visores de terrenos cinegéticos, observatorios de ciencia ciudadana, apps de gestión), pero no hay un dataset nacional consolidado en formato abierto que unifique las series históricas.

Un investigador que quiera estudiar tendencias a largo plazo necesitaría descargar 19 archivos Excel, entender la estructura interna de cada uno (que cambia entre años), resolver diferencias de nomenclatura y limpiar manualmente miles de filas. Este proyecto se encarga de la descarga, lectura, normalización y unificación de todos los anuarios en un conjunto de CSVs listos para análisis.
